...
@section('content')
    <div class="container">
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-4 mb-4">
            @foreach ($favouriteImages as $i)
                <div class="col">
                    <div class="card card-image rounded-3">
                        <img src="{{ asset('storage/uploads/' . $i->image->file) }}" class="card-img-top rounded-top-3" />
                        <div class="card-body border-top">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="title-image mb-0">{{ $i->image->title }}</h5>
                                <div>
                                    <a class="btn btn-light" href="{{ route('download', $i->image) }}">
